...
echo "Cài đặt Postfix, Dovecot, s-nail, và các công cụ cần thiết..."
...
if ! command -v certbot >/dev/null 2>&1; then
    dnf install -y certbot python3-certbot-nginx || show_error "Không thể cài đặt certbot."
fi
...
firewall-cmd --permanent --add-service={smtp,submission,imap,imaps} || show_error "Không thể mở port trên firewall."
